...
// node_modules/react-hooks-visible/lib/index.esm.js
...
var useVisible = (cb, option = {}) => {
  const targetRef = (0, import_react.useRef)(null);
  const observerRef = (0, import_react.useRef)(null);
  const [visible2, setVisible] = (0, import_react.useState)(0);
  const status = typeof cb === "function" ? cb(visible2) : visible2;
  const observerCallback = (0, import_react.useCallback)((entries) => {
...
var Z = 0.0722 * i;
function _(t) {
  const r = n(t.match(tn) || [], 9), e = r[1], u = r[2], o = r[3], i2 = r[4], c = r[5], a = r[6], l = r[7], s = r[8];
  if (void 0 !== c || void 0 !== e) {
    return [void 0 !== c ? parseInt(c, 16) : parseInt(e + e, 16), void 0 !== a ? parseInt(a, 16) : parseInt(u + u, 16), void 0 !== l ? parseInt(l, 16) : parseInt(o + o, 16), void 0 !== s ? parseInt(s, 16) : void 0 !== i2 ? parseInt(i2 + i2, 16) : 255].map((n2) => 100 * n2 / 255);
  }
}
...
var Cloud2 = function Cloud(_ref) {
  var id = _ref.id, _ref$tagCanvasOptions = _ref.tagCanvasOptions, tagCanvasOptions = _ref$tagCanvasOptions === void 0 ? {} : _ref$tagCanvasOptions, _ref$tags = _ref.tags, tags = _ref$tags === void 0 ? [] : _ref$tags, _ref$canvasContainerS = _ref.canvasContainerStyle, canvasContainerStyle = _ref$canvasContainerS === void 0 ? {} : _ref$canvasContainerS, _ref$canvasHeight = _ref.canvasHeight, canvasHeight = _ref$canvasHeight === void 0 ? 1e3 : _ref$canvasHeight, _ref$canvasWidth = _ref.canvasWidth, canvasWidth = _ref$canvasWidth === void 0 ? 1e3 : _ref$canvasWidth, _ref$canvasStyle = _ref.canvasStyle, canvasStyle = _ref$canvasStyle === void 0 ? {} : _ref$canvasStyle, _ref$type = _ref.type, type = _ref$type === void 0 ? "img" : _ref$type;
  var state = (0, import_react2.useRef)({
  ...
  var _useVisible = useVisible(function(vi) {
    return vi > 0.3;
  }), ref = _useVisible[0], visible = _useVisible[1];
  ...
  var getTag = function getTag2(_ref2) {
    var id2 = _ref2.id, title = _ref2.title, href = _ref2.href, _ref2$imgWidth = _ref2.imgWidth, imgWidth = _ref2$imgWidth === void 0 ? 32 : _ref2$imgWidth, _ref2$imgHeight = _ref2.imgHeight, imgHeight = _ref2$imgHeight === void 0 ? 32 : _ref2$imgHeight, _ref2$imgSrc = _ref2.imgSrc, imgSrc = _ref2$imgSrc === void 0 ? "" : _ref2$imgSrc, _ref2$onClick = _ref2.onClick, _onClick = _ref2$onClick === void 0 ? function() {
    } : _ref2$onClick;
    ...
    }, type === "img" ? import_react2.default.createElement("img", {
      height: imgHeight,
      width: imgWidth,
      alt: "tag",
      src: imgSrc
  ...
  }, import_react2.default.createElement("canvas", {
    id: state.canvasId,
    style: _extends2({
      width: "100%",
      maxWidth: "70vh"
...
var getTags = function getTags2(_ref2) {
  var tags2 = _ref2.tags, bgColor = _ref2.bgColor, size = _ref2.size, fallbackColor = _ref2.fallbackColor, _ref$minContrast = _ref2.minContrast, minContrast = _ref$minContrast === void 0 ? 1 : _ref$minContrast;
  return tags2.map(function(t) {
    ...
    var isAccessibleColor = tt(bgHex, originalHex) > minContrast;
    var rgb = isAccessibleColor ? _(originalHex) : _(fallbackColor);
...
var IconCloud = function IconCloud2(_ref2) {
  var id2 = _ref2.id, _ref2$tagCanvasOption = _ref2.tagCanvasOptions, tagCanvasOptions2 = _ref2$tagCanvasOption === void 0 ? {} : _ref2$tagCanvasOption, _ref2$tags = _ref2.tags, tags2 = _ref2$tags === void 0 ? [] : _ref2$tags, _ref2$canvasContainer = _ref2.canvasContainerStyle, innerStyle = _ref2$canvasContainer === void 0 ? {} : _ref2$canvasContainer, _ref2$canvasHeight = _ref2.canvasHeight, canvasHeight2 = _ref2$canvasHeight === void 0 ? 1e3 : _ref2$canvasHeight, _ref2$canvasWidth = _ref2.canvasWidth, canvasWidth2 = _ref2$canvasWidth === void 0 ? 1e3 : _ref2$canvasWidth, _ref2$canvasStyle = _ref2.canvasStyle, canvasStyle2 = _ref2$canvasStyle === void 0 ? {} : _ref2$canvasStyle, fallbackHexColor = _ref2.fallbackHexColor, backgroundHexColor = _ref2.backgroundHexColor, size = _ref2.iconSize, _ref2$minContrastRati = _ref2.minContrastRatio, minContrast = _ref2$minContrastRati === void 0 ? 1 : _ref2$minContrastRati;
  var tags22 = getTags({
    tags: tags2,
  ...
  return import_react2.default.createElement(Cloud2, {
    id: id2,
    tagCanvasOptions: tagCanvasOptions2,
    tags: tags22,
